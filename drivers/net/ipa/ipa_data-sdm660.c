...
/* Endpoint configuration for the SDM660 SoC. */
...
/* IPA-resident memory region configuration for the SDM660 SoC. */
...
/* Configuration data for the SDM660 SoC. */
const struct ipa_data ipa_data_sdm660 = {
